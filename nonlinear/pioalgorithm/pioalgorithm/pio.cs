    ...
    public class PIO
    {
        public static void Process(Function type)
        {
            ...
            for (int run = 0; run < Parameter.Run; ++run)
            {
                ...
                trajectoryName = type.ToString() + ".pio." + Parameter.Dimension.ToString()
                                    + "." + run.ToString() + ".txt";
                Write.writeTrajectory(trajectoryName, ref trajectory);

                logSentence = type.ToString() + " fitness[pio] " + gbestValue.ToString()
                    + ", run " + run.ToString();
            ...
            logName = "_" + type.ToString() + ".pio." + Parameter.Dimension.ToString() + ".txt";

            // global count
            logSentence = type.ToString() + " pio count2 " + count2.ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);

            logSentence = type.ToString() + " pio count4 " + count4.ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);
            ...
            logSentence = type.ToString() + " pio best fitness "
                + fitnessRun[0].ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);

            // middle of global star best fitness
            logSentence = type.ToString() + " pio middle fitness "
                + fitnessRun[Parameter.Run / 2].ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);

            // worst of global star best fitness
            logSentence = type.ToString() + " pio worst fitness "
            ...
            logSentence = type.ToString() + " " + Parameter.Run.ToString()
                        + " runs, pio global best mean " + mean.ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);
