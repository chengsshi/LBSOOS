...
namespace PIOalgorithm
{
    public class PIOrs
    {
        public static void Process(Function type)
        {
            ...
            int np = Parameter.Population; // Convert.ToInt32(Math.Ceiling(Parameter.Population / 2.0));
            ...
            for (int run = 0; run < Parameter.Run; ++run)
            {
                ...
                {
                    np = Convert.ToInt32(Math.Ceiling(Parameter.Population / 2.0));
                ...
                trajectoryName = type.ToString() + ".piors." + Parameter.Dimension.ToString()
                                    + "." + run.ToString() + ".txt";
                Write.writeTrajectory(trajectoryName, ref trajectory);

                logSentence = type.ToString() + " fitness[piors] " + gbestValue.ToString()
                    + ", run " + run.ToString();
            ...
            logName = "_" + type.ToString() + ".piors." + Parameter.Dimension.ToString() + ".txt";

            // global count
            logSentence = type.ToString() + " piors count2 " + count2.ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);

            logSentence = type.ToString() + " piors count4 " + count4.ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);
            ...
            logSentence = type.ToString() + " " + Parameter.Run.ToString()
                        + " runs, global best mean " + mean.ToString();
            Console.WriteLine(logSentence);
            log.Add(logSentence);
